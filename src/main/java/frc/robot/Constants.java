...
public class Constants {
    public class DriveConstants{
        ...
        public static final double kAlignP = 0.4;
        public static final double kAlignI = 0;
        public static final double kAlignD = 0.22;

        public static final double kDriveP = 0.8;
    ...
    public class FuelConstants {
        ...
        public static double shootingIntakeSpeed = 0.2;
        ...
        public static final double kShooterS = 0.06;
    ...
    public class ClimbConstants {
        ...
        public static final double climbUpPos = 305;
        public static final double climbDownPos = -60;

        public static final double kClimberP = 0.22;
        ...
        public static final double kClimberMaxVoltage = 5;
    }
    ...
    public class towerAutoConstants {
        ...
        public static final double drive3Meters = 0.5;
